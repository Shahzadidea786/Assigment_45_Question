...
console.log(number1 <= number2);
// Tests using "and" and "or" operators
console.log("Is number1 greater than 5 and number2 less than 8? I predict True.");
console.log(number1 > 5 && number2 < 8);
console.log("Is number1 less than 8 or number2 greater than 10? I predict True.");
